[Full episode](/830/the-forever-trial)
Toggle Audio and Transcript Sync

Transcript
| Episode #830 | May 17, 2024
...
(SUBJECT) VICTIM FAMILY MEMBER 1: Hi.

#### Victim Family Member 2

(SUBJECT) VICTIM FAMILY MEMBER 2: Hi, everyone.

#### Victim Family Member 3

(SUBJECT) VICTIM FAMILY MEMBER 3: Hi, everybody.
...
(SUBJECT) VICTIM FAMILY MEMBER 4: You are not 80.
...
(SUBJECT) VICTIM FAMILY MEMBER 6: Yeah.
...
(SUBJECT) VICTIM FAMILY MEMBER 9: Moussaoui.
...
(SUBJECT) VICTIM FAMILY MEMBER 10: Kaczynski.
...
(SUBJECT) VICTIM FAMILY MEMBER 17: I'm so sorry.
...
Our website, thisamericanlife.org. *This* *American* *Life* is delivered to public radio stations by PRX, the Public Radio Exchange. Thanks, as always, to our program's co-founder, Mr. Torey Malatia. He told me that growing up, his family had not one, not two, but three wells in the backyard. I was like, really?
